import { CLICK_AUDIO, TICK_AUDIO } from "./Main.js";
...
export class GamePage extends Page {
    constructor(players) {
        ...
        this.cardDoneButton.addEventListener("click", function () {
            this.hideCard();
            this.showTOD();
            CLICK_AUDIO.play();
            window.setTimeout(this.round.bind(this), 1000);
        }.bind(this));
        this.cardDrinkButton.addEventListener("click", function () {
            this.hideCard();
            this.showTOD();
            CLICK_AUDIO.play();
            window.setTimeout(this.round.bind(this), 1000);
        }.bind(this));
        this.truthButton.addEventListener("click", function () {
            if (!this.canClickTODButtons)
                return;
            CLICK_AUDIO.play();
        ...
        this.dareButton.addEventListener("click", function () {
            if (!this.canClickTODButtons)
                return;
            CLICK_AUDIO.play();
            frontTitleText.innerText = "ACTION";
            let i = Math.floor(Math.random() * dare.length);
    ...
    round() {
        this.canClickTODButtons = false;
        this.randomDraw(0, 50.0, function (player) {
            // this.showCard();
